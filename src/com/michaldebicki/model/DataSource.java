package com.michaldebicki.model;
...
//    albums.name , song.track
    ...
    private PreparedStatement queryArist;
    ...
    public boolean open() {
        try {
            ...
            queryArist = conn.prepareStatement(QUERY_ARTIST);
    ...
    public List<SongArtist> querySongInfoView(String title) {
        try {
            querySongInfoView.setString(1, title); //1nka do 1 znaku zapytania
    ...
    private int insertArtist(String name) throws SQLException {
        queryArist.setString(1, name);
        ResultSet results = queryArist.executeQuery();
        if (results.next()) {
